...
//register User 
	...
	public String saveUser(@ModelAttribute UserDtls user, @RequestParam("img") MultipartFile file, HttpSession session) throws MessagingException {
	    ...
	    if (!ObjectUtils.isEmpty(savedUser)) {
	        if (!file.isEmpty()) {
	            try {
	                ...
	                session.setAttribute("errorMsg", "Error saving image: " + e.getMessage());
	        ...
	        commonUtil.sendRegistrationEmail(user.getEmail(), subject, body);
	...
	//		Rest  Password Code 
		...
		private void updateUserResetToken(String email, String resetToken) {
